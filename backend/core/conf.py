...
class Settings(BaseSettings):
    ...
    LOG_CID_UUID_LENGTH: int = 32  # must be <= 32
    ...
    CORS_ALLOWED_ORIGINS: list[str] = [
        'http://localhost:5173',  # Frontend address, do not include trailing '/'
    ]
    ...
    OPERA_LOG_ENCRYPT_KEY_INCLUDE: list[str] = [  # Encrypt the values of the parameters corresponding to the encrypted interface input parameters
        'password',
        'old_password',
        'new_password',
        'confirm_password',
